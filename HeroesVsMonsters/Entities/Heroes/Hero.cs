...
namespace HeroesVsMonsters.Entities.Heroes
{
   public class Hero : Entity
   {
      ...
      public bool Escape(Entity e)
      {
         int r = new Random().Next(100);
         int luckToEscape = StatEntity[StatType.Speed] - e.StatEntity[StatType.Speed];
         if (luckToEscape > new Random().Next(r)) return true;
         else return false;
      }
      ...
      protected override void GenerateStats()
      {
         ...
         StatEntity[StatType.Speed] = Dice.Throws(DiceType.D10, 10,8);
      }
